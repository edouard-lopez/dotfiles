...
export PATH=$PATH:$HOME/apps/:/usr/local/bin/:$HOME/bin/
export STYLERC="$HOME/projects/stylerc/stylerc"
export ES_HOME="/etc/elasticsearch"
...
function git-add-remote() {
  remoteUrl="${1:-ssh://git@git.edouard-lopez.com:822/root/$remoteBranch.git}"
  remoteBranch="${2:-manu}"
...
# Serveur deployment
alias sync-irsii@manu='scp -r -P 822 /mnt/data/system/home/.irssi ed8@vm-ed:/home/ed8/'
alias sync-weechat@manu='scp -r -P 822 "$HOME"/.weechat ed8@vm-ed:/home/ed8/'
alias irc="ssh ed8@vm-ed -p 822 -t 'screen -r irc'"
