...
plugins=( battery bower command-not-found composer history jump gpg-agent git git-extras npm nvm pip python rvm sprunge ssh-agent yeoman history-substring-search )
